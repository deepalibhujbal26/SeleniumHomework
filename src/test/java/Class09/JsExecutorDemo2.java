...
public class JsExecutorDemo2  extends CommonMethods {
    public static void main(String[] args) throws InterruptedException {
      ...
      inputBox.sendKeys("Deepali");
       ...
       // Thread.sleep(2000);
        WebElement  sumbitBtn= driver.findElement(By.xpath("//button[@id='submit_button']"));
        js.executeScript("arguments[0].click();",sumbitBtn);
